...
import static uk.gov.gchq.magmacore.service.DataObjectSvc.REF_BASE;
import static uk.gov.gchq.magmacore.service.DataObjectSvc.USER_BASE;
import static uk.gov.gchq.magmacore.service.DataObjectSvc.event;
import static uk.gov.gchq.magmacore.service.DataObjectSvc.uid;
...
public final class ExampleDataObjects {
    ...
    public static List<Thing> createDataObjects() {
        ...
        // Would be good to add part_of_by_class_(ccupantInPropertyKindOfAssociation) but can't
