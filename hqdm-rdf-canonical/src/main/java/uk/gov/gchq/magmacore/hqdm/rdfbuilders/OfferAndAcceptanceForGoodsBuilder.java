...
public class OfferAndAcceptanceForGoodsBuilder {
    ...
    public OfferAndAcceptanceForGoodsBuilder(final IRI iri) {
        offerAndAcceptanceForGoods = SpatioTemporalExtentServices.createOfferAndAcceptanceForGoods(iri.getIri());
    }
    ...
    /**
     * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#CONSISTS_OF_} relationship type where an
     ...
     * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#PART_OF} exactly one {@link SaleOfGoods}.
     *
