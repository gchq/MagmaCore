 ...
 */
public class MoneyAssetBuilder {

    private final MoneyAsset moneyAsset;
    ...
    public MoneyAssetBuilder(final IRI iri) {
        moneyAsset = SpatioTemporalExtentServices.createMoneyAsset(iri.getIri());
    }
     ...
     * asset is a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#PARTICIPANT_IN} exactly one
     * {@link Ownership}.
     *
