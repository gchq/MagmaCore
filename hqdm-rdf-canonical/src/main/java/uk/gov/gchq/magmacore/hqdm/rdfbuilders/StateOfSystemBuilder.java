...
public class StateOfSystemBuilder {
    ...
    public StateOfSystemBuilder(final IRI iri) {
        stateOfSystem = SpatioTemporalExtentServices.createStateOfSystem(iri.getIri());
    }
     ...
     * {@link StateOfSystem} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one
