...
public class StateOfAssociationBuilder {
    ...
    public StateOfAssociationBuilder(final IRI iri) {
        stateOfAssociation = SpatioTemporalExtentServices.createStateOfAssociation(iri.getIri());
    }
     ...
     * {@link StateOfAssociation} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF}
