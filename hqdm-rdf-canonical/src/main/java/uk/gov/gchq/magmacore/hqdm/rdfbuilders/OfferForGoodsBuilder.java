...
public class OfferForGoodsBuilder {
    ...
    public OfferForGoodsBuilder(final IRI iri) {
        offerForGoods = SpatioTemporalExtentServices.createOfferForGoods(iri.getIri());
    }
     ...
     * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one or more {@link ClassOfOffer}.
     *
     ...
     * {@link OfferForGoods} may be {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#PART_OF} no more
