...
public class PhysicalQuantityBuilder {
    ...
    public PhysicalQuantityBuilder(final IRI iri) {
        physicalQuantity = SpatioTemporalExtentServices.createPhysicalQuantity(iri.getIri());
    }
     ...
     * {@link PhysicalQuantity} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF}
    ...
    /**
     * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} relationship type where a
     * {@link PhysicalQuantity} is a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF}
