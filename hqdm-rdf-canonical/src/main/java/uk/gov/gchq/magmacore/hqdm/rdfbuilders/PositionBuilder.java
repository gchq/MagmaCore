...
public class PositionBuilder {
    ...
    public PositionBuilder(final IRI iri) {
        position = SpatioTemporalExtentServices.createPosition(iri.getIri());
    }
    ...
    /**
     * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#COMPONENT_OF} relationship type where an
     ...
     * {@link Position} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one or
