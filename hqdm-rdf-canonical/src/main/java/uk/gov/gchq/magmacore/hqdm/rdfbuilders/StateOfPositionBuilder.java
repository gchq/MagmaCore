...
public class StateOfPositionBuilder {
    ...
    public StateOfPositionBuilder(final IRI iri) {
        stateOfPosition = SpatioTemporalExtentServices.createStateOfPosition(iri.getIri());
    }
     ...
     * {@link StateOfPosition} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF}
