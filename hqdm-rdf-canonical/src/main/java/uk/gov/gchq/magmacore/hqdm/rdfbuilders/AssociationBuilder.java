...
public class AssociationBuilder {
    ...
    public AssociationBuilder(final IRI iri) {
        association = SpatioTemporalExtentServices.createAssociation(iri.getIri());
    }
     ...
     * {@link Association} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one or
     ...
     * {@link Association} is a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one or
