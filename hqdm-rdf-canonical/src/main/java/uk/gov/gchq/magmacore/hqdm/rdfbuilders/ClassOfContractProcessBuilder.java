 ...
 */
public class ClassOfContractProcessBuilder {

    private final ClassOfContractProcess classOfContractProcess;
    ...
    /**
     * Returns an instance of ClassOfContractProcess created from the properties set on this builder.
     *
