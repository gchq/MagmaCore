...
public class AgreeContractBuilder {
    ...
    public AgreeContractBuilder(final IRI iri) {
        agreeContract = SpatioTemporalExtentServices.createAgreeContract(iri.getIri());
    }
    ...
    /**
     * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#CONSISTS_OF} relationship type where the
     * {@link AgreeContract} {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#CONSISTS_OF} exactly one
     ...
     * {@link AgreeContract} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one
     ...
     * {@link AgreeContract} is {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#PART_OF} exactly one
