...
public class ClassOfContractExecutionBuilder {
    ...
    public ClassOfContractExecutionBuilder(final IRI iri) {
        classOfContractExecution = ClassServices.createClassOfContractExecution(iri.getIri());
    }
     ...
     * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#PART_OF} a
     * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} the {@link ClassOfContractProcess}.
     *
