...
public class PersonInPositionBuilder {
    ...
    public PersonInPositionBuilder(final IRI iri) {
        personInPosition = SpatioTemporalExtentServices.createPersonInPosition(iri.getIri());
    }
     ...
     * {@link PersonInPosition} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF}
