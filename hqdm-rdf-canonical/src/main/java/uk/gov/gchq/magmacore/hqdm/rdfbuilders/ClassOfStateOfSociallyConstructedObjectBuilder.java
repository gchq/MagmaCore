...
public class ClassOfStateOfSociallyConstructedObjectBuilder {
    ...
    public ClassOfStateOfSociallyConstructedObjectBuilder(final IRI iri) {
        classOfStateOfSociallyConstructedObject = RdfClassServices
    ...
    public final ClassOfStateOfSociallyConstructedObjectBuilder consists__Of_By_Class(
        ...
        classOfStateOfSociallyConstructedObject.addValue(CONSISTS__OF_BY_CLASS,
    ...
    public final ClassOfStateOfSociallyConstructedObjectBuilder has_Superclass(final Class clazz) {
        classOfStateOfSociallyConstructedObject.addValue(HAS_SUPERCLASS, new IRI(clazz.getId()));
        return this;
    }
    ...
    public final ClassOfStateOfSociallyConstructedObjectBuilder member__Of(final Class clazz) {
        classOfStateOfSociallyConstructedObject.addValue(MEMBER__OF, new IRI(clazz.getId()));
        return this;
    }
    ...
    public final ClassOfStateOfSociallyConstructedObjectBuilder member_Of(final ClassOfClass classOfClass) {
        classOfStateOfSociallyConstructedObject.addValue(MEMBER_OF, new IRI(classOfClass.getId()));
        return this;
    }
    ...
    public final ClassOfStateOfSociallyConstructedObjectBuilder member_Of_(
        ...
        classOfStateOfSociallyConstructedObject.addValue(MEMBER_OF_,
    ...
    public final ClassOfStateOfSociallyConstructedObjectBuilder part__Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        classOfStateOfSociallyConstructedObject.addValue(PART__OF_BY_CLASS,
                new IRI(classOfSpatioTemporalExtent.getId()));
        return this;
    }
    ...
    public ClassOfStateOfSociallyConstructedObject build() throws HqdmException {
        if (classOfStateOfSociallyConstructedObject.hasValue(HAS_SUPERCLASS)
                && classOfStateOfSociallyConstructedObject.value(HAS_SUPERCLASS)
                        .isEmpty()) {
            throw new HqdmException("Property Not Set: has_superclass");
        }
        if (classOfStateOfSociallyConstructedObject.hasValue(MEMBER__OF)
                && classOfStateOfSociallyConstructedObject.value(MEMBER__OF).isEmpty()) {
            throw new HqdmException("Property Not Set: member__of");
        }
        if (classOfStateOfSociallyConstructedObject.hasValue(MEMBER_OF)
                && classOfStateOfSociallyConstructedObject.value(MEMBER_OF).isEmpty()) {
            throw new HqdmException("Property Not Set: member_of");
        }
        if (classOfStateOfSociallyConstructedObject.hasValue(MEMBER_OF_)
                && classOfStateOfSociallyConstructedObject.value(MEMBER_OF_).isEmpty()) {
            throw new HqdmException("Property Not Set: member_of_");
        }
        if (classOfStateOfSociallyConstructedObject.hasValue(PART__OF_BY_CLASS)
                && classOfStateOfSociallyConstructedObject.value(PART__OF_BY_CLASS)
                        .isEmpty()) {
            throw new HqdmException("Property Not Set: part__of_by_class");
        }
        return classOfStateOfSociallyConstructedObject;
    }
}
