...
public class InstalledObjectBuilder {
    ...
    public InstalledObjectBuilder(final IRI iri) {
        installedObject = SpatioTemporalExtentServices.createInstalledObject(iri.getIri());
    }
     ...
     * {@link InstalledObject} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF}
