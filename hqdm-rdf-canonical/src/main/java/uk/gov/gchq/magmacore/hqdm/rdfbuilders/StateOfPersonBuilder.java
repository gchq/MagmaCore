 ...
 */
public class StateOfPersonBuilder {

    private final StateOfPerson stateOfPerson;
    ...
    public StateOfPersonBuilder(final IRI iri) {
        stateOfPerson = SpatioTemporalExtentServices.createStateOfPerson(iri.getIri());
    }
     ...
     * {@link StateOfPerson} may be a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.IRI.HQDM#MEMBER_OF} one
