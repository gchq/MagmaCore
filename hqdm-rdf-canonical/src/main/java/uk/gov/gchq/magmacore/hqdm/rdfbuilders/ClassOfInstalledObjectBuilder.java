 ...
 */
public class ClassOfInstalledObjectBuilder {

    private final ClassOfInstalledObject classOfInstalledObject;
    ...
    public ClassOfInstalledObjectBuilder(final IRI iri) {
        classOfInstalledObject = ClassServices.createClassOfInstalledObject(iri.getIri());
    }
    ...
    /**
     * Returns an instance of ClassOfInstalledObject created from the properties set on this builder.
     *
