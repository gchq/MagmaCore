 ...
 */
public class ClassOfPartyBuilder {

    private final ClassOfParty classOfParty;
    ...
    public ClassOfPartyBuilder(final IRI iri) {
        this.classOfParty = ClassServices.createClassOfParty(iri);
    }
    ...
    public final ClassOfPartyBuilder consists__Of_By_Class(
        ...
        this.classOfParty.addValue(CONSISTS__OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public final ClassOfPartyBuilder has_Superclass(final Class clazz) {
        this.classOfParty.addValue(HAS_SUPERCLASS, clazz.getId());
        return this;
    }
    ...
    public final ClassOfPartyBuilder member__Of(final Class clazz) {
        this.classOfParty.addValue(MEMBER__OF, clazz.getId());
        return this;
    }
    ...
    public final ClassOfPartyBuilder member_Of(final ClassOfClass classOfClass) {
        this.classOfParty.addValue(MEMBER_OF, classOfClass.getId());
        return this;
    }
    ...
    public final ClassOfPartyBuilder member_Of_(
        ...
        this.classOfParty.addValue(MEMBER_OF_, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public final ClassOfPartyBuilder part__Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfParty.addValue(PART__OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfParty build() throws HqdmException {
        if (this.classOfParty.hasValue(HAS_SUPERCLASS)
                && this.classOfParty.values(HAS_SUPERCLASS).isEmpty()) {
            throw new HqdmException("Property Not Set: has_superclass");
        }
        if (this.classOfParty.hasValue(MEMBER__OF)
                && this.classOfParty.values(MEMBER__OF).isEmpty()) {
            throw new HqdmException("Property Not Set: member__of");
        }
        if (this.classOfParty.hasValue(MEMBER_OF)
                && this.classOfParty.values(MEMBER_OF).isEmpty()) {
            throw new HqdmException("Property Not Set: member_of");
        }
        if (this.classOfParty.hasValue(MEMBER_OF_)
                && this.classOfParty.values(MEMBER_OF_).isEmpty()) {
            throw new HqdmException("Property Not Set: member_of_");
        }
        if (this.classOfParty.hasValue(PART__OF_BY_CLASS)
                && this.classOfParty.values(PART__OF_BY_CLASS).isEmpty()) {
