...
public class KindOfPartyBuilder {
    ...
    /**
     * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF_BY_CLASS} relationship type where
     * each {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a
    ...
    public KindOfParty build() throws HqdmException {
        if (!this.kindOfParty.hasValue(HAS_COMPONENT_BY_CLASS)) {
